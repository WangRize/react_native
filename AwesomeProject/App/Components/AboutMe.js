    ...
    return (
      ...
      <ScrollView style={{ width: Common.window.width, height: Common.window.height, marginTop: -20, backgroundColor: 'rgba(240,240,240,0.9)' }}>
        <Image
          ...
          >
          <Text style={styles.welcome}>ReacNative</Text>
          <Text style={{ position: 'absolute', marginTop: 80, marginLeft: 30, color: 'white' }}>普通会员</Text>
          <Text style={{ position: 'absolute', top: 30, marginLeft: Common.window.width - 50, color: 'white' }}>设置</Text>
          <Text style={{ position: 'absolute', marginLeft: Common.window.width - 80, bottom: 10, color: 'white' }}>账户管理</Text>
        </Image>
